                                    ...
                                    <div class="card-header biru">
                                        <div class="row">
                                            ...
                                            <div class="col-1">
                                                ...
                                                <a type="button" class="text-light float-right" href="angsuran.php">
...
<?php
    ...
    function bayar($data) {
        ...
        mysqli_query($conn,"UPDATE angsuran set status = '$status', tanggal = '$tgl_bayar', user_id = '$user', jasa = '$data_jasa' where id = '$id'");
        ...
        mysqli_query($conn, "INSERT INTO kas (tanggal, kas_masuk, keterangan, kode_reff)
                                                    VALUES ('$tgl_bayar', '$nominal_bayar','$ket','$kode')");
        //isi ke tabel hasil_usaha
        mysqli_query($conn, "INSERT INTO hasil_usaha (tanggal, debet, kredit, keterangan, kode_reff)
                                                    VALUES ('$tgl_bayar', '$data_jasa', 0,'Jasa $ket','$kode')");

<?php
    ...
    if(empty($halaman)){
        ...
        $no = $posisi+1;
            ...
            $sql=mysqli_query($conn, "SELECT dj.kode_barang, b.nama_barang, b.harga_jual, dj.kuantitas, (b.harga_jual * dj.kuantitas) total
                                    from detail_jual dj 
                                    join barang b on b.kode_barang = dj.kode_barang
                                    join penjualan p on p.id = dj.penjualan_id
                                    where p.id = '$penjualan_id' order by dj.id asc limit $posisi,$batas");
            $sql2=mysqli_query($conn, "SELECT p.*, sum(b.harga_jual * dj.kuantitas) total_all, u.nama_user user, c.nama_customer
                                    from detail_jual dj 
                                    join barang b on b.kode_barang = dj.kode_barang
                                    join penjualan p on p.id = dj.penjualan_id
            ...
            @$id_customer =  $data_sql['customer_id'];
            @$nama =  $data_sql['nama_customer'];
            @$user = $data_sql['user'];
            @$kode = $data_sql['kode_jual'];
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow row">
                    ...
                    <div>
                        <h3 class="mr-6 ml-4 mt-2 hitam"><i class="fab fa-sellsy mx-2 text-dark"></i> Detail Penjualan</h3>
                    </div>
                    <div class="col-3"></div>
                            ...
                            <div class="container-fluid px-4">
                                <div class="card mb-1">
                                    ...
                                    <div class="card-body2">
                                        <div class="row">
                                            <div class="col-7">
                                                <table class="small mb-3 mt-3 hitam" id="dataTable" width ="500px" cellspacing="0">
                                                        <tr>
                                                            <th>ID Customer</th>
                                                            <th>: <?= $id_customer ?></th>
                                                            <th class="px-3"></th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <!-- <td class="text-center">
                                                            <a type="button" class="aksi text-dark" id="tombolUbah" data-toggle='modal' data-target="#kirimPengajuan" 
                                                                data-id="<?= $detail['id']; ?>"
                                                                data-a_id="<?= $detail['a_id']; ?>"
                                                                data-anggota_id="<?= $detail['anggota_id']; ?>"
                                                                data-nama_anggota="<?= $nama ?>"
                                                                data-nominal_angsur="Rp <?= number_format($detail["nominal_angsur"],2,',','.'); ?>"
                                                                data-detail="Ke - <?= $detail['detail']; ?>"
                                                                data-kopin="<?= $detail['kode_pinjam']; ?>"
                                                                data-nopin="Rp <?= number_format($detail["nominal_acc"],2,',','.'); ?>"
                                                                data-tanggal_angsur="Rp <?= date('d-m-Y',strtotime($detail['tgl_detail'])) ?>"
                                                                data-nomang="<?= $detail['nominal_angsur']; ?>"
                                                                data-tangsur="<?= $detail['tgl_detail']; ?>"
        ...
        <div class="modal-dialog">
            <div class="modal-content-supplier">
                <div class="modal-header align-self-center">
                    <h5 class="modal-title hitam mx-5" id="addtarifLabel">Data Detail Penjualan</h5>
                </div>

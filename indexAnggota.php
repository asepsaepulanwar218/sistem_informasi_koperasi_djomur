<?php
    ...
    $saldo = mysqli_query($conn, "SELECT saldo from saldo_daily where anggota_id = '$nama_user' and tanggal in (select max(tanggal) from saldo_daily where anggota_id = '$nama_user')");
    $saldo = mysqli_fetch_array($saldo);
    @$saldo = $saldo['saldo'];

    $pinjaman = mysqli_query($conn, "SELECT (sum(nominal_acc) - sum(nominal_bayar)) pinjaman from pinjaman where anggota_id = '$nama_user' ");
    $pinjaman = mysqli_fetch_array($pinjaman);
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow hitam">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="ganti_password_anggota.php">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">
                                                Pinjaman Anda</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Rp <?= number_format($pinjaman,2,',','.'); ?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                                        </div>

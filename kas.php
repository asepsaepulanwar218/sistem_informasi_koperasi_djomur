    ...
    if(empty($halaman)){
        ...
        if (isset($_POST['filter'])) {
            ...
            if ($t_awal != 0 or $t_akhir != 0) {
                $sql=mysqli_query($conn, "SELECT * from kas where tanggal between '$t_awal' and '$t_akhir' order by tanggal asc");
                ...
                $sql=mysqli_query($conn, "SELECT * from kas order by tanggal asc");
            ...
            $sql=mysqli_query($conn, "SELECT * from kas where tanggal between '1111-11-11' and '0000-00-00' order by tanggal asc");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow row">
                    ...
                    <div>
                        <h3 class="mr-6 ml-4 mt-2 hitam"><i class="fas fa-money-check mx-2 text-dark"></i> Laporan Kas</h3>
                    </div>
                    <div class="col-3"></div>
                                ...
                                <div class="card mb-1">
                                    <div class="card-header biru">
                                        <div class="row">
                                            ...
                                            <div class="col-1">
                                                <!-- Print Laporan-->
                                                <form action="cetak_kas.php" method="post" class="form-inline float-right" target="_blank">
                                                <div class="mb-2 mx-2">
                                            ...
                                            <table class="table-utama tabel fix" id="dataTable" width="100%" cellspacing="0" border>
                                                ...
                                                <tbody class="small">
                                                    <tr>
                                                        ...
                                                        <td><?= $kas["kode_reff"]; ?></td>
                                                        <td class="text-right">Rp <?= number_format($kas["kas_masuk"],2,',','.'); ?></td>
                                                        <td class="text-right">Rp <?= number_format($kas["kas_keluar"],2,',','.'); ?></td>

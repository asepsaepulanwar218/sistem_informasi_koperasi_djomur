        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow row">
                    ...
                    <div>
                        <h3 class="mr-6 ml-4 mt-2 hitam"><i class="fab fa-sellsy mx-2 text-dark"></i> Konfirmasi Pembelian</h3>
                    </div>
                    <div class="col-3"></div>
                                    ...
                                    <div class="card-header biru">
                                        <div class="row">
                                            ...
                                            <div class="col-1">
                                                ...
                                                <a type="button" class="text-light float-right" href="penerimaan_barang.php">
                                                    ...
                                                    <form action="" method="post" enctype="multipart/form-data" id="formPenjualan" name="formTambahPenjualan">
                                                        <tr>
                                                            ...
                                                            <th>
                                                                ...
                                                                <label for="biaya" class="form-label">Aktual Biaya</label>
                                                                <input type="number" class="form-control form-control-sm hitam " name="biaya" id = "biaya" autocomplete="off"  onFocus="startCalc3();" onBlur="stopCalc3();" required>
                                                            </th>
                                                            <th class="px-2"></th>
                                                            <th width='40%'>
...
function konfirmasi_pembelian ($data) {
    ...
    mysqli_query($conn, "UPDATE pembelian set status = 'Selesai', total = '$total_all', biaya = '$biaya' where id = '$id' ");
    ...
    mysqli_query($conn, "INSERT INTO hasil_usaha (tanggal, debet, kredit, keterangan, kode_reff)
                                                VALUES ('$tanggal', 0, '$biaya','Biaya Pembelian Barang','$kode')");

<?php
    ...
    $maxId = mysqli_query($conn, "SELECT max(id) as idTerbesar FROM pembelian");
    $data = mysqli_fetch_array($maxId);
    $idPembelian = $data['idTerbesar'] + 1;
    ...
    if(empty($halaman)){
        ...
        $no = $posisi+1;
            ...
            $sql=mysqli_query($conn, "SELECT db.id, db.kode_barang, b.nama_barang, b.harga_beli, db.kuantitas, (b.harga_beli * db.kuantitas) total, b.stok
                                    ...
                                    where db.pembelian_id is null order by db.id asc limit $posisi,$batas");
            $sql2=mysqli_query($conn, "SELECT sum(b.harga_beli * db.kuantitas) total_all
                                    from detail_beli db 
                                    join barang b on b.kode_barang = db.kode_barang
                                    where db.pembelian_id is null order by db.id asc limit $posisi,$batas");
...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow row">
                    ...
                    <div>
                        <h3 class="mr-6 ml-4 mt-2 hitam"><i class="fas fa-shopping-cart mx-2 text-dark"></i> Pengajuan Pembelian</h3>
                    </div>
                    <div class="col-3"></div>
                                    ...
                                    <div class="card-header biru">
                                        <div class="row">
                                            ...
                                            <div class="col-1">
                                                ...
                                                <a type="button" class="text-light float-right" href="pengajuan_pembelian.php">
                                        ...
                                        <div class="row">
                                            <div class="col-11">
                                                ...
                                                <form action="" method="post" enctype="multipart/form-data" id="formPenjualan" name="formTambahPenjualan">
                                                        <tr>
                                                            <th>
                                                                <label for="id_supplier" class="form-label hitam">Supplier</label>
                                                                <select class="custom-select hitam" name="id_supplier" id="id_supplier" readonly>
                                                                    <option value=""> </option>
                                                                    <?php
                                                                    $dataSupplier=mysqli_query($conn,"SELECT * FROM supplier order by id DESC");
                                                                    while ($data = mysqli_fetch_array($dataSupplier)){
                                                                        echo '<option name="id_supplier" value="'.$data['id'].'" class=" hitam">'.$data['nama_supp'].'</option>';
                                                                    }?>
                                                                </select>
                                                            </th>
                                                            <th class="px-2"></th>
                                                            ...
                                                            <th class="px-2"></th>
                                                            <th>
                                                                <label for="total_bayar" class="form-label hitam">Total Belanja</label>
                                                                ...
                                                                <input type="hidden" class="form-control form-control-sm hitam" name="totbay" id = "totbay" autocomplete="off" readonly value="<?= $total_all ?>" onFocus="startCalc3();" onBlur="stopCalc3();">
                                                            </th>
                                                            <th class="px-2"></th>
                                                            <th>
                                                                <label for="biaya" class="form-label hitam">Biaya</label>
                                                                <input type="number" class="form-control form-control-sm hitam" name="biaya" id = "biaya" autocomplete="off" required onFocus="startCalc3();" onBlur="stopCalc3();">
                                                            </th>
                                                            <th class="px-2"></th>
                                                            <th>
                                                                <label for="total_semua" class="form-label hitam">Total Bayar</label>
                                                                <input type="text" class="form-control form-control-sm hitam" name="total_semua" id = "total_semua" autocomplete="off" readonly onFocus="startCalc3();" onBlur="stopCalc3();">
                                                            </th>
                                                            <th class="px-2"></th>
                                                            <th width='13%'>
                                                                <button type="submit" class="btn btn-outline-primary btn-sm mt-4" name ="simpan-pembelian">Kirim Pengajuan</button>
                                                            </th>
                                                            <!-- <th class="px-"></th>
                                                            <th>
                                                            ...
                                                            <th class="px-"></th>
                                                            <th>
                                                                <button type="button" class="btn btn-outline-warning btn-sm mt-4 alert_batalkan" href="reset_pembelian.php">Reset</button>
                                                            </th>
                                                        </tr>
                                                    </form>
                                                </table>
                                                    ...
                                                    <tbody class="small">
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                <a class="aksi text-dark alert_notif" href="hapus.php?detail_beli_id=<?= $detail["id"]; ?>"><i class="fas fa-solid fa-trash small"></i></a>
                                                            </td>
                                                        </tr>
                                                    </tbody>
    ...
    <div class="modal fade" id="addtarif" tabindex="-1" aria-labelledby="addtarifLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content-supplier">
                <div class="modal-header">
                    <h5 class="modal-title hitam" id="addtarifLabel">Pengajuan Pembelian</h5>
                </div>
                    ...
                    <form action="" method="post" enctype="multipart/form-data" id="formTambah" name="formTambahData">
                        <div class="mb-2">
                            ...
                            <select class="custom-select hitam" name="kode_barang" id="kode_barang" onchange="cek_db()" readonly>
                                <option value=""> </option>
                                <?php
                                $sql=mysqli_query($conn,"SELECT * FROM barang order by kode_barang DESC");
                        ...
                        <div class="mb-2">
                            <label for="harga_beli" class="form-label small">Harga</label>
                            <input type="number" class="form-control form-control-sm hitam" name="harga_beli" id = "harga_beli" required maxlength="100" autocomplete="off" readonly onFocus="startCalc();" onBlur="stopCalc();">
                        </div>   
                        <div class="mb-2">
...
<?php
     ...
     if(isset($_POST["tambah-barang"])) {
        ...
        if (tambah_barang($_POST) > 0) {
            echo "<script>document.location.href = 'pengajuan_pembelian.php';</script>"; 
        } else {
            echo "
            <script>
                Swal.fire(
                'Gagal!',
                'Barang ini sudah diinput, Silahkan edit jika ada perubahan',
                'error'
    ...
    function tambah_barang ($data) {
        ...
        $cekjual = mysqli_query($conn,"SELECT count(kode_barang) barang FROM detail_beli WHERE kode_barang='$kode_barang' and pembelian_id is null");
        ...
        if ($cekjualgak != 0) {
            ...
            $query = "INSERT INTO detail_beli (kode_barang, kuantitas)
                    VALUES
       ...
       if (ubah_barang($_POST) > 0) {
           ...
           <script>
               ...
               'error'
                   ...
                   if (isConfirm) {
                       document.location.href = 'pengajaun_pembelian.php';
                   } else {
                   //if no clicked => do something else
                   }
               })
   ...
   if(isset($_POST["simpan-pembelian"])) {
    ...
    function simpan_pembelian ($data) {
        ...
        $query = "INSERT INTO pembelian (id, supplier_id, user_id, kode_beli, tanggal, total, keterangan, status, biaya)
                    VALUES
                    ('$idPembelian', '$id_supplier', '$user', '$kode', '$tanggal', '$total_all', '$ket', 'Pengajuan', '$biaya')
                    ";
...
<script>
    ...
    function calc() {
        one = document.formTambahData.harga_beli.value;
    ...
    function calc3() {
        one = document.formTambahPenjualan.totbay.value;
        two = document.formTambahPenjualan.biaya.value;
        document.formTambahPenjualan.total_semua.value = (one * 1) + (two * 1);
    }

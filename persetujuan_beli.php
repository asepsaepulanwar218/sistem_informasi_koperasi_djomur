        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow row">
                    ...
                    <div>
                        <h3 class="mr-6 ml-4 mt-2 hitam"><i class="fab fa-sellsy mx-2 text-dark"></i> Persetujuan Pembelian</h3>
                    </div>
                    <div class="col-3"></div>
                                    ...
                                    <div class="card-header biru">
                                        <div class="row">
                                            ...
                                            <div class="col-1">
                                                ...
                                                <a type="button" class="text-light float-right" href="persetujuan_pembelian.php">
                                        ...
                                        <div class="row">
                                            <div class="col-7">
                                                <table class="small mb-3 mt-3 hitam" id="dataTable" width ="600px" cellspacing="0" border="0">
                                                        <tr>
                                                            <th>Saldo Kas Saat Ini</th>
                                                            <th>: Rp <?= number_format($akhir,2,',','.'); ?></th>
                                                            <th></th>
                                                            <th></th>
                                                            <th></th>
                                                        </tr>
                                                ...
                                                <table class="small mb-1 mt-3 hitam" id="dataTable" width ="100%" cellspacing="0" border='0'>
                                                    <form action="" method="post" enctype="multipart/form-data" id="formPenjualan" name="formTambahPenjualan">
                                                        <tr>
                                                            ...
                                                            <th>
                                                                <label for="total_bayar" class="form-label hitam">Alasan Jika Ditolak / Keterangan Acc</label>
                                                                <input type="textarea" class="form-control form-control-sm hitam" name="keterangan" id = "keterangan" autocomplete="off" required>
                                                            ...
                                                            <th class="px-2"></th>
                                                            <th width='12%'>
                                                                <button type="submit" class="btn btn-outline-success btn-sm mt-4" name ="setujui-pembelian">Setujui</button>
                                                            </th>
                                                            <!-- <th class="px-"></th>
                                                            <th>
                                                            ...
                                                            <th class="px-"></th>
                                                            <th>
                                                                <button type="submit" class="btn btn-outline-danger btn-sm mt-4" name ="tolak-pembelian">Tolak</button>
                                                            </th>
                                                        </tr>
                                                    </form>
                                                </table>
...
// Simpan pembelian
if(isset($_POST["setujui-pembelian"])) {
    if ($jabatan != 'ketua') {
        echo "
        <script>
            Swal.fire(
...
function setujui_pembelian ($data) {
    global $conn;
    global $user;
    global $total_all;
    ...
    $query = "UPDATE pembelian set status = 'Disetujui', keterangan = '$keterangan' where id = '$id' ";
...
//                      ).then(function(isConfirm) {
//                          if (isConfirm) {
//                              document.location.href = 'persetujuan_beli.php?pembelian_id=document.write(id)';
//                          } 
//                  });
//              </script>"; 
//     } else {
